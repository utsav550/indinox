...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('drivers.join.store') }}" id="joinForm">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="tel" name="phone" class="form-input"
                       placeholder="10-digit mobile number" value="{{ old('phone') }}" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="license_number" class="form-input"
                       placeholder="e.g. GJ01 20110012345" value="{{ old('license_number') }}" required
                       style="font-family:'IBM Plex Mono',monospace;">
            </div>

            {{-- TRUCK DETAILS (owner-operator only) --}}
            <div class="truck-section" id="truckSection">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="registration_number" class="form-input"
                           placeholder="e.g. GJ01AB1234" value="{{ old('registration_number') }}"
                           style="font-family:'IBM Plex Mono',monospace;">
                </div>
                    ...
                    <select name="truck_type_id" class="form-select">
                        ...
                        @foreach($truckTypes as $type)
                            <option value="{{ $type->id }}"
                                {{ old('truck_type_id') == $type->id ? 'selected' : '' }}>
                                {{ $type->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group" style="margin-bottom:0;">
                    ...
                    <input type="number" name="capacity" class="form-input"
                           placeholder="e.g. 20" value="{{ old('capacity') }}" step="0.5">
                </div>
            </div>
