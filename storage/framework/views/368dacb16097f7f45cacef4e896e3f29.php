...
<div class="form-wrap">
    ...
    <div class="notice">
        ⚡ This adds a driver directly as approved (internal use). To let drivers self-register, share the <a href="<?php echo e(route('drivers.join')); ?>" style="font-weight:700; color:#92400E;">signup link</a>.
    </div>

    <form method="POST" action="<?php echo e(route('drivers.store')); ?>" class="form-card">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-footer">
            <a href="<?php echo e(route('drivers.index')); ?>" class="btn-cancel">Cancel</a>
