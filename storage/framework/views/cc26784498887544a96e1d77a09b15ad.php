...
<body>
    ...
    <aside id="sidebar">
        ...
        <nav class="nav-section">
            <?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="nav-label"><?php echo e(ucfirst($section)); ?></div>
                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $isActive = str_starts_with($currentRoute, $item['match']); ?>
                    <a href="<?php echo e($item['href']); ?>"
                       class="nav-item <?php echo e($isActive ? 'active' : ''); ?>">
    ...
    <div id="main">
        ...
        <header id="topbar">
            <div class="topbar-breadcrumb">
                indinox / <span><?php echo e($currentLabel); ?></span>
            </div>
